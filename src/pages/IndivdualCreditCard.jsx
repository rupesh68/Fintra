    ...
    <div className=" w-[100vw] h-[100%] rounded-[10px] flex flex-col">
      ...
      <div className="flex justify-center items-center">
        <div className="  flex justify-center mt-10 w-[256px] h-[29px]  items-center ">
          <h1 className="text-[#00000099] font-montserrat font-semibold text-[35px]">Credit Cards</h1>
        </div>
        </div>
      ...
      <div className=" flex items-center gap-3 mt-5 ml-4">
        ...
        <p className="font-montserrat font-semibold text-[#5C5A5A] text-[14px]">HDFC Regalia Gold</p>
      </div>
...
<div className="mt-10">
  <p className=" font-montserrat font-semibold text-[20px] leading-[24.38px] ">Most Compared Credit Cards</p>
</div>
